...
#set_property PACKAGE_PIN P3 [get_ports {UART_SELECT}]					
#	set_property IOSTANDARD LVCMOS33 [get_ports {UART_SELECT}]
...
#set_property PACKAGE_PIN F15 [get_ports button_up]						
...
#set_property PACKAGE_PIN V10 [get_ports button_dw]						
#	set_property IOSTANDARD LVCMOS33 [get_ports button_dw]
...
#set_property PACKAGE_PIN F14 [get_ports {PmodA_RsTx}]					
#	set_property IOSTANDARD LVCMOS33 [get_ports {PmodA_RsTx}]
##Bank = 15, Pin name = IO_L16N_T2_A27_15,					Sch name = JA3
#set_property PACKAGE_PIN D17 [get_ports {PmodA_RsRx}]					
#	set_property IOSTANDARD LVCMOS33 [get_ports {PmodA_RsRx}]
...
set_property PACKAGE_PIN C4 [get_ports JTAG_RsRx]						
	set_property IOSTANDARD LVCMOS33 [get_ports JTAG_RsRx]
#Bank = 35, Pin name = IO_L11N_T1_SRCC_35,					Sch name = UART_RXD_OUT
set_property PACKAGE_PIN D4 [get_ports JTAG_RsTx]						
	set_property IOSTANDARD LVCMOS33 [get_ports JTAG_RsTx]
